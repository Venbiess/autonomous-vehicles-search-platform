...
COORDINATOR_SERVER_ENDPOINT = _env_first(
    "COORDINATOR_SERVER_ENDPOINT",
    "COORDINATOR_SERVICE_ENDPOINT",
    "http://coordinator-server:9013",
)
COORDINATOR_SERVER_TIMEOUT_SEC = int(
    _env_first("COORDINATOR_SERVER_TIMEOUT_SEC", "COORDINATOR_SERVICE_TIMEOUT_SEC", "30")
)
...
COORDINATOR_SERVICE_ENDPOINT = COORDINATOR_SERVER_ENDPOINT
COORDINATOR_SERVICE_TIMEOUT_SEC = COORDINATOR_SERVER_TIMEOUT_SEC
